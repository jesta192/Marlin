...
//
#define FIL_RUNOUT_PIN                        44  // ROT1 Connector
#define FIL_RUNOUT2_PIN                       42  // ROT2 Connector

//
// Temperature Sensors
//
#define TEMP_0_PIN                            13 //15 for E0:Left  // T1 Connector
#define TEMP_1_PIN                            15 //13 for E0:Left  // T3 Connector
#define TEMP_BED_PIN                          14  // BED Connector (Between T1 and T3)

//
// Heaters / Fans
//
#define HEATER_0_PIN                           9 //8 for E0:Left  // Misc Connector, pins 5 and 6 (Out3)
#define HEATER_1_PIN                           8 //9 for E0:Left  // Misc Connector, pins 3 and 4 (Out2)
